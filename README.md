...
## Technology Used
* **Backend Framework:** .NET 10.0 (For api)
...
### 3. Build the project from root directory of the project
```bash
dotnet build
```
...
dotnet run
```
Open browser and go to the url: `http://localhost` where application is running 
